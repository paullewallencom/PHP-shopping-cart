...
echo "</td>";
echo "</table>";if($ordrow['delivery_add_id'] == 0)
{
...
echo "</table>";
$itemssql = "SELECT products.*, orderitems.*,
orderitems.id AS itemid FROM products, orderitems
WHERE orderitems.product_id = products.id AND order
_id = " . $validid;
$itemsres = mysql_query($itemssql);
$itemnumrows = mysql_num_rows($itemsres);echo "<h1>Products Purchased</h1>";
echo "<table cellpadding=10>";
echo "<th></th>";
echo "<th>Product</th>";
echo "<th>Quantity</th>";
